          ...
          <div className="bg-slate-900 text-white rounded-3xl p-6 border border-slate-800 space-y-4">
            ...
            <div className="space-y-3 text-xs text-slate-300">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <strong className="text-white block">Adresse du Siège :</strong>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <strong className="text-white block">Téléphone Fixe / Mobile :</strong>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <span>infosystemprosper@gmail.com / contact@informatiquesystem.com</span>
                </div>
              </div>
            </div>
          </div>
